...
public class MD5Util implements Serializable {
    ...
    public static String getMD5Str16(String s) {
        return getMD5Str32(s).substring(8, 24);
    }

    public static String getMD5Str32(String s) {
        if (s == null) {
            return "";
        } else {
            md5Init();
    ...
    public static void main(String[] args) {
        System.out.println(getMD5Str32("hello world"));
        System.out.println(getMD5Str16("hello world"));
    }
    */
}
